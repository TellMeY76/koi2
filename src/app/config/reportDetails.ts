...
export const SCHEDULES = [
    ...
    },
    {
        title: '财税计划',
        schedule: [
            {content: '检查企业汽车租赁有无续', tip: '规避发票不合理入账风险 ', date: '2019.3.15', executive: '易创顾问 齐培培', complete: 'false'},
            ...
            {content: '设置研发费用台账，便于加计扣除及研发补贴申请 ', tip: '10万研发费用节税2万', date: '2019.4.17', executive: '易创顾问 齐培培', complete: 'false'},
            ...
            {content: '对比税收与同区退税起征点', tip: '筹划放弃退税还是享受退税有利', date: '2019.10.23', executive: '易创顾问 齐培培', complete: 'false'},

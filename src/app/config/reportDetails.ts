...
export const REPO_DETAILS: RepoDetail[] = [
    {
        ...
        statusLabel: '注册基本信息',
        status: ['公司名称：宁波亿诺药业有限公司（待定）', '注册地址：宁波新材料创新中心东区1幢1号8-4-1',
            '注册资本：1000万', '经营范围：药物研发',
            ' 股东信息：武汉英纳药业有限公司：100万元 10%，周平：510万元 51%，姜凤超  230万 23%，钟壁光 20万 2%，ZUYU GUO 90万 9%，WEI WU 50万 5% ', '法定代表人/董事长：周平 ；监事：王旭 '],

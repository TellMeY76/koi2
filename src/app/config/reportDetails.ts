...
export const SCHEDULES = [
    ...
    },
    {
        title: '财税计划',
        schedule: [
            {content: '检查企业汽车租赁有无续租，规避发票不合理入账风险 ', date: '2019.3.15', executive: '易创会计', complete: 'false'},
            {content: '小规模纳税人2季度税收筹划 ', date: '2019.3.20', executive: '易创会计', complete: 'false'},
            {content: '2季度企业所得税预估及筹划 ', date: '2019.3.20', executive: '易创会计', complete: 'false'},
            {content: '完成员工信息采集表填写 ', date: '2019.4.1', executive: '企业负责人', complete: 'false'},
            {content: '根据员工信息采集表，出具政策享受评估报告 ', date: '2019.4.2', executive: '易创会计', complete: 'false'},
            {content: '根据员工信息采集表，考虑研发费用入账及加计扣除 ', date: '2019.4.3', executive: '易创会计', complete: 'false'},
            {content: '填写研发项目立项计划表 ', date: '2019.4.15', executive: '企业负责人', complete: 'false'},
            {content: '设置研发费用台账，便于加计扣除及研发补贴申请 ', date: '2019.4.17', executive: '易创会计', complete: 'false'},
            {content: '业务招待费、广宣费、三项经费税前扣除比例核算，进行所得税税收筹划 ', date: '2019.4.20', executive: '易创会计', complete: 'false'},
            {content: '核对往来款，理清应收及欠款，防止企业资产流失 ', date: '2019.5.5', executive: '易创会计', complete: 'false'},
            {content: '测算企业半年度税负率是否达标，规避企业涉税风险', date: '2019.5.13', executive: '易创会计', complete: 'false'},
            {content: '核查企业印花税、房产税、城建税等小税种缴纳情况，并作汇报', date: '2019.6.12', executive: '易创会计', complete: 'false'},
            {content: '小规模纳税人强制升级一般纳税人监控，避免无法开票风险 ', date: '2019.7.5', executive: '易创会计', complete: 'false'},
            {content: '预估年度所得税，修订当年税筹方案', date: '2019.7.18', executive: '易创会计', complete: 'false'},
            {content: '核对是否欠税，规避税务稽查风险', date: '2019.8.4', executive: '易创会计', complete: 'false'},
            {content: '业务招待费、广宣费、三项经费税前扣除比例核算，进行所得税税收筹划 ', date: '2019.9.19', executive: '易创会计', complete: 'false'},
            {content: '确定企业所在园区退税起征点及退税比例，筹划放弃退税还是享受退税有利', date: '2019.10.23', executive: '易创会计', complete: 'false'},
            {content: '检测注册资本金到位，到位后及时汇报并缴纳印花税', date: '2019.11.12', executive: '易创会计', complete: 'false'},
            {content: '测算企业年度税负率是否达标，规避企业涉税风险', date: '2019.11.20', executive: '易创会计', complete: 'false'},
            {content: '预估年度所得税，修订当年税筹方案', date: '2019.12.1', executive: '易创会计', complete: 'false'},
            {content: '核对往来款，提醒股东及时还款，避免个税风险', date: '2019.12.4', executive: '易创会计', complete: 'false'},
            {content: '定制年终奖发放策略，进行员工个人所得税税收筹划', date: '2019.12.20', executive: '易创会计', complete: 'false'},
            {content: '预提费用冲销提醒，规避纳税风险', date: '2019.12.23', executive: '易创会计', complete: 'false'},
            {content: '核算企业当年利润，进行企业所得税年度筹划', date: '2019.12.24', executive: '易创会计', complete: 'false'},
        ]
